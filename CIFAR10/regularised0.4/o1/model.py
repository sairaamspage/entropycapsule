...
class ResNetPreCapsule(nn.Module):
    def __init__(self, block, num_blocks):
        ...
        self.layer2 = self._make_layer(block, 128, num_blocks[1], stride=2)#(b_size,64,16,16)
        #self.layer3 = self._make_layer(block, 128, num_blocks[2], stride=1)#(b_size,128,16,16)
...
class ResnetCnnsovnetDynamicRouting(nn.Module):
    def __init__(self):
        ...
        #self.conv_caps4 = ConvCapsule(in_caps=32,in_dim=16,out_caps=32,out_dim=16,kernel_size=3,stride=1,padding=1)        
